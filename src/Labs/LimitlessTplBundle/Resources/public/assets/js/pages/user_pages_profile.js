...
$(function() {
    ...
    require.config({
        paths: {
            ...
            limitless: 'assets/js/plugins/visualization/echarts/theme/limitless',
            line: 'assets/js/plugins/visualization/echarts/chart/lin',
            bar: 'assets/js/plugins/visualization/echarts/chart/bar'
        }
    });
    ...
    require(
        [
            'echarts',
            'limitless',
            'line',   // load-on-demand, don't forget the Magic switch type.
            'bar'
        ],
