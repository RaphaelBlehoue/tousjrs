 ...
 */
class Version20170418153852 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE draft draft INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE draft draft TINYINT(1) DEFAULT NULL');
